## SCRIPT CON LAS ARQUITECTURAS DE LOS BLOQUES DOWN, MID Y UP PARA UNA RED U-NET
...
"""
    ...
    t_emb_dim: dimensión del vector de embedding temporal. Si se usa, introduce información temporal en el modelo (int)
    ...
    cross_attn: indica si se usará atención cruzada (útil para incluir información contextual adicional, como texto en modelos de texto a imagen) (bool)
    context_dim: dimensión del vector de contexto para la atención cruzada. Requerido si cross_attn=True (int)
"""
